...
namespace SolucionAlumno
{
    public class SolucionAlumno_v10 : ISolucion
    {
        ...
        {
            return new ConnectionFindAbstraction().ConnectionFind(new AStar(new BinaryTree<Node>(), new Hashtable()), listaCheckPoint, mapaDeCostos, new PreProcesingZonesMatrix(mapaDeCostos.getDimensiones().Width, mapaDeCostos.getDimensiones().Height, zonasProhibidas));
        }
