...
{
    public class SolucionAlumno_v20 : ISolucion
    {
        ...
        {
            return "Solucion_v2.0, A* Basico, FibbonacciHeap para abiertos. H(x)= DiagonalShorcut + TieBreaks + Prueba y error. +Optimisacion.";
        }
