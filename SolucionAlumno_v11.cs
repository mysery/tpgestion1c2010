...
namespace SolucionAlumno
{
    public class SolucionAlumno_v11 : ISolucion
    {
        ...
        {
            return new ConnectionFindAbstraction().ConnectionFind(new AStar(new HashTableWithMinimum(), new HashTableWithMinimum()), listaCheckPoint, mapaDeCostos, new PreProcesingZones(mapaDeCostos.getDimensiones().Width, mapaDeCostos.getDimensiones().Height, zonasProhibidas));
        }
